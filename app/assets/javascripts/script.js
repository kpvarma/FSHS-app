...
var appStream = {
	...
	init: function($elem, options) {
		...
		// themed throbber
		this.options.throbber = '<img src="https://hootsuite.s3.amazonaws.com/2-7-15/images/themes/'+ this.options.hs_params.theme +'/loader.gif" alt="Loading..." class="throbber" style="vertical-align:middle;" />'; // margin-bottom:3px;
	...
	show_default_stream: function(offset) {
		...
		self.clearAjax();
        self.jqxhr = $.post('app-toolbox.ajax.php', params, function(data) {
